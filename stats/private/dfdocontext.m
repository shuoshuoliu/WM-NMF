...
%DFDOCONTEXT Perform context menu actions for Distribution Fitter
...
uimenu(hMenu,'Label',getString(message('stats:dfstrings:label_Color')),'Tag','color','Callback',@dfdocontext);
...
umark = uimenu(hMenu,'Label',getString(message('stats:dfstrings:label_Marker')),'Tag','marker','Position',2);

% Add menu items to control confidence bounds
uimenu(hMenu,'Label',getString(message('stats:dfstrings:label_ConfidenceBounds')),'Callback',@dfdocontext,...
            'Tag','confbounds');
...
cData = uicontextmenu('Parent',dffig,'Tag','datacontext','Callback',@dfdocontext);
