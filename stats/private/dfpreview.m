...
tempfigure=figure('units','pixels',...
    'WindowStyle', 'normal',...
...
% Use sspi-1 to be safe, otherwise, on Windows with high DPI and Surface pro3, 
% the prevew window missing one (right) border.
rsppi = strjoin({'-r',num2str(sppi-1)},'');

x=print(tempfigure, '-RGBImage','-opengl', rsppi);
