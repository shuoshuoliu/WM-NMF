...
%DFCREATEPLOT Create plot window for Distribution Fitter
...
dftitle = getString(message('stats:dfstrings:dlg_DistributionFittingTool'));
...
%CLOSEFIG Verify intention to close Distribution Fitter figure
