...
%   variable that can be a categorical variable, numeric vector, string
%   array, character matrix, or single-column cell array of strings.  GROUP
%   can also be a matrix whose columns represent different grouping
...
%       load carsmall; maineffectsplot(Weight,{Model_Year,Cylinders}, ...
