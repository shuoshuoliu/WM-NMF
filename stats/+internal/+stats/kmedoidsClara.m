...
options = statset(options,'Streams',S,'UseSubstreams',false,'UseParallel',false,'Display','off');
...
randIndex = randsample(S,setdiff(1:size(X,1),medoidIndex),numSamples,false);
