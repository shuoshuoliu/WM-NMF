...
%  datetime vector, a duration vector, a logical vector, a cell vector of
...
%  * For a numeric, datetime, duration or logical vector G, the set of 
%    group levels is the distinct values of G. The order is the sorted 
