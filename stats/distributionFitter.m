function varargout=distributionFitter(varargin)
%distributionFitter Open Distribution Fitter 
%
...
s = settings;
if (s.stats.DistributionFitter.LegacyDistributionFitter.ActiveValue == true) 
    [varargout{1:nargout}] = JavaDFApp(varargin{:});
    return;
end
