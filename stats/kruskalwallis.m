...
%     has the same number of elements (balanced).  GROUP can be a string
%     array, character array or a cell array of strings, with one row per
%     column of X, containing the group names.  Enter an empty array ([])
