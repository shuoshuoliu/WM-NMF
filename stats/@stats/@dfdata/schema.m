...
schema.prop(c, 'name',      'ustring');       % data set name
...
p=schema.prop(c, 'viewData',     'MATLAB array'); % The view data obj associated with this dataset 
p.AccessFlags.Serialize = 'off';

p=schema.prop(c, 'binRulesPanel',     'MATLAB array'); % The bin rules panel obj associated with this dataset 
p.AccessFlags.Serialize = 'off';
