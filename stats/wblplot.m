...
%   plotted lines.
%
%   WBLPLOT(AX,X) takes a handle AX in addition to the data in X. AX is a
...
set(ax,'YTick',tick,'YTickLabel',label,'XScale','log');
...
title(ax,getString(message('stats:probplot:WeibullProbPlot')));
