...
%   WHICHSTATS can be a single string such as 'leverage', a string array or
%   cell array of strings such as {'leverage' 'standres' 'studres'}.  By
%   default, REGSTATS returns all statistics. Valid statistic strings are:
%
%      Name          Meaning
