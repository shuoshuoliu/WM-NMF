...
%     % variables related to auto construction and performance % X =
%     X(~any(isnan(X(:,1:16)),2),:); Y = X(:,16); Y = log(Y); X =
%     X(:,3:15); predictorNames = {'wheel-base' 'length' 'width' 'height'
%     ...
%         'curb-weight' 'engine-size' 'bore' 'stroke' 'compression-ratio'
%         ... 'horsepower' 'peak-rpm' 'city-mpg' 'highway-mpg'};
%
%     % Compute the default sequence of lasso fits. [B,S] =
%     lasso(X,Y,'CV',10,'PredictorNames',predictorNames);
%
%     % Display a trace plot of the lasso fits. axTrace = lassoPlot(B,S);
%
%     % Display the sequence of cross-validated predictive MSEs. axCV =
